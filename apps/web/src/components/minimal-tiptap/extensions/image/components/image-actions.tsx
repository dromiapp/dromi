...
import { CopyIcon, DownloadIcon, EllipsisIcon, LinkIcon, MaximizeIcon } from 'lucide-react'
...
const ActionItems: Array<{
  ...
  isLink?: boolean
    ...
    { key: 'onView', icon: <MaximizeIcon className="size-4" />, tooltip: 'View image' },
    { key: 'onDownload', icon: <DownloadIcon className="size-4" />, tooltip: 'Download image' },
    { key: 'onCopy', icon: <CopyIcon className="size-4" />, tooltip: 'Copy image to clipboard' },
